...
<head>
    ...
    <link href="<?php echo e(asset('main.87c0748b313a1dda75f5.css')); ?>" rel="stylesheet">
  <style>
    .preview-zone {
...
<div class="app-container app-theme-white body-tabs-shadow fixed-header fixed-sidebar">
    <?php echo $__env->make('admin.layout.inc.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <?php echo $__env->make('admin.layout.inc.ui_settings', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <div class="app-main">
            <?php echo $__env->make('admin.layout.inc.sidebar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>

            <div class="app-main__outer">
                <div class="app-main__inner">
                    <?php echo $__env->yieldContent('content'); ?>
                </div>
                <?php echo $__env->make('admin.layout.inc.footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            </div>
    </div>
</div>
...
<script type="text/javascript" src="<?php echo e(asset('assets/scripts/main.87c0748b313a1dda75f5.js')); ?>"></script>
<script>
...
<?php /**PATH E:\xampp\htdocs\ecommerce\resources\views/admin/layout/master.blade.php ENDPATH**/ ?>