                                                                    ...
                                                                    <div class="avatar-wrapper mt-2 avatar-wrapper-overlap">
                                                                        <div class="avatar-icon-wrapper avatar-icon-sm">
                                                                            <div class="avatar-icon"><img
                                                                                    src="<?php echo e(asset('assets/images/avatars/1.jpg')); ?>"
                                                                                    alt=""></div>
                                                                        </div>
                                                                        <div class="avatar-icon-wrapper avatar-icon-sm">
                                                                            <div class="avatar-icon"><img
                                                                                    src="<?php echo e(asset('assets/images/avatars/2.jpg')); ?>"
                                                                                    alt=""></div>
                                                                        </div>
                                                                        <div class="avatar-icon-wrapper avatar-icon-sm">
                                                                            <div class="avatar-icon"><img
                                                                                    src="<?php echo e(asset('assets/images/avatars/3.jpg')); ?>"
                                                                                    alt=""></div>
                                                                        </div>
                                                                        <div class="avatar-icon-wrapper avatar-icon-sm">
                                                                            <div class="avatar-icon"><img
                                                                                    src="<?php echo e(asset('assets/images/avatars/4.jpg')); ?>"
                                                                                    alt=""></div>
                                                                        </div>
                                                                        <div class="avatar-icon-wrapper avatar-icon-sm">
                                                                            <div class="avatar-icon"><img
                                                                                    src="<?php echo e(asset('assets/images/avatars/5.jpg')); ?>"
                                                                                    alt=""></div>
                                                                        </div>
                                                                        <div class="avatar-icon-wrapper avatar-icon-sm">
                                                                            <div class="avatar-icon"><img
                                                                                    src="<?php echo e(asset('assets/images/avatars/9.jpg')); ?>"
                                                                                    alt=""></div>
                                                                        </div>
                                                                        <div class="avatar-icon-wrapper avatar-icon-sm">
                                                                            <div class="avatar-icon"><img
                                                                                    src="<?php echo e(asset('assets/images/avatars/7.jpg')); ?>"
                                                                                    alt=""></div>
                                                                        </div>
                                                                        <div class="avatar-icon-wrapper avatar-icon-sm">
                                                                            <div class="avatar-icon"><img
                                                                                    src="<?php echo e(asset('assets/images/avatars/8.jpg')); ?>"
                                                                                    alt=""></div>
                                                                        </div>
                ...
                <div class="dropdown">
                    <button type="button" data-toggle="dropdown" class="p-0 mr-2 btn btn-link">
                        <span class="icon-wrapper icon-wrapper-alt rounded-circle">
                            ...
                            <span class="language-icon opacity-8 flag large <?php echo e(Session::get('language') == 'en' ? 'US' : 'BD'); ?>"></span>
                        </span>
                    </button>
                    <div tabindex="-1" role="menu" aria-hidden="true" class="rm-pointers dropdown-menu dropdown-menu-right">
                        ...
                        <form id="language_form" action="<?php echo e(route('language')); ?>" method="post">
                            <?php echo csrf_field(); ?>
                            <button type="submit" name="language" tabindex="0" class="dropdown-item" value="en">
                                <span class="mr-3 opacity-8 flag large US"></span>
                                English
                            </button>
                            <button type="submit" name="language" tabindex="0" class="dropdown-item" value="bn">
                                <span class="mr-3 opacity-8 flag large BD"></span>
                                Bangla
                            </button>
                        </form>
                    </div>
                        ...
                        <div class="widget-content-left">
                            <div class="btn-group">
                                <a data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="p-0 btn">
                                    <img width="42" class="rounded-circle" src="<?php echo e(asset('assets/images/avatars/1.jpg')); ?>" alt="">
...
</div><?php /**PATH E:\xampp\htdocs\ecommerce\resources\views/admin/layout/inc/header.blade.php ENDPATH**/ ?>