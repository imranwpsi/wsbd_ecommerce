            ...
            <ul class="vertical-nav-menu">
                <li>
                    <a href="<?php echo e(url('admin')); ?>">
                        ...
                        </i><?php echo e(trans('label.dashboards')); ?>
                ...
                <li>
                    <a href="#">
                        ...
                        <?php echo e(trans('label.products')); ?>
                    ...
                    <ul>
                        <li>
                            <a href="#">
                               ...
                               <?php echo e(trans('label.physical_products')); ?>
                            ...
                            <ul>
                                <li>
                                    <a href="<?php echo e(url('admin/category')); ?>">
                                        ...
                                        </i><?php echo e(trans('label.category')); ?>
                                ...
                                <li>
                                    <a href="<?php echo e(url('admin/brand')); ?>">
                                        <i class="metismenu-icon">
                                        </i><?php echo e(trans('label.brand')); ?>
                                ...
                                <li>
                                    <a href="<?php echo e(url('admin/subCategory')); ?>">
                                        <i class="metismenu-icon">
                                        </i><?php echo e(trans('label.sub-category')); ?>

                                    </a>
                                </li>
                                <li>
                                    <a href="<?php echo e(url('admin/subSubCategory')); ?>">
                                        <i class="metismenu-icon">
                                        </i><?php echo e(trans('label.sub-sub-category')); ?>
...
</div><?php /**PATH E:\xampp\htdocs\ecommerce\resources\views/admin/layout/inc/sidebar.blade.php ENDPATH**/ ?>