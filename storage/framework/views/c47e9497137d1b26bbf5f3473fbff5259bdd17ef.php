                                    ...
                                    <div class="widget-content p-0">
                                        <div class="widget-content-wrapper">
                                            <div class="widget-content-left mr-3">
                                                <div class="widget-content-left">
                                                    <img width="40" class="rounded-circle" src="<?php echo e(asset('assets/images/avatars/4.jpg')); ?>" alt="">
                                                </div>
                                            </div>
                                ...
                                <td>
                                    <div class="widget-content p-0">
                                        <div class="widget-content-wrapper">
                                            <div class="widget-content-left mr-3">
                                                <div class="widget-content-left">
                                                    <img width="40" class="rounded-circle" src="<?php echo e(asset('assets/images/avatars/3.jpg')); ?>" alt="">
                                                </div>
                                            </div>
                                            <div class="widget-content-left flex2">
                                ...
                                <td>
                                    <div class="widget-content p-0">
                                        <div class="widget-content-wrapper">
                                            <div class="widget-content-left mr-3">
                                                <div class="widget-content-left">
                                                    <img width="40" class="rounded-circle" src="<?php echo e(asset('assets/images/avatars/2.jpg')); ?>" alt="">
                                                </div>
                                            </div>
                                            <div class="widget-content-left flex2">
                                ...
                                <td>
                                    <div class="widget-content p-0">
                                        <div class="widget-content-wrapper">
                                            <div class="widget-content-left mr-3">
                                                <div class="widget-content-left">
                                                    <img width="40" class="rounded-circle" src="<?php echo e(asset('assets/images/avatars/1.jpg')); ?>" alt=""></div>
                                            </div>
                                            <div class="widget-content-left flex2">
                        ...
                        <div class="dropdown-menu-header-inner bg-dark">
                            ...
                            <div class="menu-header-content btn-pane-right">
                                <div class="avatar-icon-wrapper mr-3 avatar-icon-xl btn-hover-shine">
                                    <div class="avatar-icon rounded"><img src="<?php echo e(asset('assets/images/avatars/3.jpg')); ?>" alt="Avatar 5"></div>
                                </div>
                                <div>
                            ...
                            <div class="menu-header-content btn-pane-right">
                                <div class="avatar-icon-wrapper mr-3 avatar-icon-xl btn-hover-shine">
                                    <div class="avatar-icon rounded">
                                        <img src="<?php echo e(asset('assets/images/avatars/8.jpg')); ?>" alt="Avatar 5">
                                    </div>
                                </div>
                                <div>
                    ...
                    <div class="dropdown-menu-header">
                        <div class="dropdown-menu-header-inner bg-dark">
                            ...
                            <div class="menu-header-content btn-pane-right">
                                <div class="avatar-icon-wrapper mr-3 avatar-icon-xl btn-hover-shine">
                                    <div class="avatar-icon rounded">
                                        <img src="<?php echo e(asset('assets/images/avatars/1.jpg')); ?>" alt="Avatar 5"></div>
                                </div>
                                <div>
...
<?php echo $__env->make('admin.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\ecommerce\resources\views/admin/index.blade.php ENDPATH**/ ?>