...
<div class="col-lg-12">
    <div class="main-card mb-3 card">
        <div class="card-body">
            <h5 class="card-title">
                <?php echo app('translator')->get('label.sub_category'); ?>
            </h5>
        	<button type="button" class="btn mr-2 mb-2 btn-primary float-right addModalBtn" url="<?php echo e(route('subCategory.create')); ?>">
        	    <?php echo e(trans('label.create_sub_category')); ?>
            ...
            <table class="mb-0 table table-hover table-bordered">
                ...
                <tr>
                    ...
                    <th class="text-center"><?php echo e(trans('label.category')); ?></th>
                ...
                <tr>
                    ...
                    <td class="text-center"><?php echo e($category->category->name??''); ?></td>
                    <td class="text-center">
                        <?php $__currentLoopData = $brandArr; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $brand): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php echo isset($brandArr[$key][$i]) ? '<span class="badge badge-primary">'.$brands[$brandArr[$key][$i]].'</span>' : ''; ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\ecommerce\resources\views/admin/subCategory/index.blade.php ENDPATH**/ ?>