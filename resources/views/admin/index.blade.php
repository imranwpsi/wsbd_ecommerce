                        ...
                        <div class="dropdown-menu-header-inner bg-dark">
                            ...
                            <div class="menu-header-content btn-pane-right">
                                <div class="avatar-icon-wrapper mr-3 avatar-icon-xl btn-hover-shine">
                                    <div class="avatar-icon rounded"><img src="{{asset('assets/images/avatars/3.jpg')}}" alt="Avatar 5"></div>
                                </div>
                                <div>
                            ...
                            <div class="menu-header-content btn-pane-right">
                                <div class="avatar-icon-wrapper mr-3 avatar-icon-xl btn-hover-shine">
                                    <div class="avatar-icon rounded">
                                        <img src="{{asset('assets/images/avatars/8.jpg')}}" alt="Avatar 5">
                                    </div>
                                </div>
                                <div>
                    ...
                    <div class="dropdown-menu-header">
                        <div class="dropdown-menu-header-inner bg-dark">
                            ...
                            <div class="menu-header-content btn-pane-right">
                                <div class="avatar-icon-wrapper mr-3 avatar-icon-xl btn-hover-shine">
                                    <div class="avatar-icon rounded">
                                        <img src="{{asset('assets/images/avatars/1.jpg')}}" alt="Avatar 5"></div>
                                </div>
                                <div>
