...
<div class="col-lg-12">
    <div class="main-card mb-3 card">
        <div class="card-body">
            <h5 class="card-title">
                @lang('label.sub_category')
            </h5>
        	<button type="button" class="btn mr-2 mb-2 btn-primary float-right addModalBtn" url="{{ route('subCategory.create') }}">
        	    {{trans('label.create_sub_category')}}
        	</button>
            <table class="mb-0 table table-hover table-bordered">
                ...
                <tr>
                    ...
                    <th class="text-center">{{trans('label.category')}}</th>
                ...
                <tr>
                    ...
                    <td class="text-center">
                        @foreach($brandArr as $i => $brand)
                        {!! isset($brandArr[$key][$i]) ? '<span class="badge badge-primary">'.$brands[$brandArr[$key][$i]].'</span>' : '' !!}
                        @endforeach
                    </td>
                    <td class="text-center">
