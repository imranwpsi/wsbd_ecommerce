<div class="app-header header-shadow">
    ...
    <div class="app-header__content">
        <div class="app-header-left">
            ...
            {{-- <form id="language_form" action="{{url('language')}}">
                <select class="selectpicker" data-width="fit" name="change_language" id="cl">
                    <option data-content='<span class="flag-icon flag-icon-gb"></span> EN' @if(isset($_COOKIE['language']) && $_COOKIE['language']=="en") selected @endif value="en">
                     EN
                    </option>
                    <option data-content='<span class="flag-icon flag-icon-bd"></span> বাংলা' @if(isset($_COOKIE['language']) && $_COOKIE['language']=="bn") selected @endif value="bn">
                     বাংলা
                    </option>
                ...
                <div class="dropdown">
                    <button type="button" data-toggle="dropdown" class="p-0 mr-2 btn btn-link">
                        <span class="icon-wrapper icon-wrapper-alt rounded-circle">
                            ...
                            <span class="language-icon opacity-8 flag large {{ Session::get('language') == 'en' ? 'US' : 'BD' }}"></span>
                        </span>
                    </button>
                    <div tabindex="-1" role="menu" aria-hidden="true" class="rm-pointers dropdown-menu dropdown-menu-right">
                        ...
                        <form id="language_form" action="{{ route('language') }}" method="post">
                            @csrf
